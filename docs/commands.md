...
To do a sanity check of your singularity-compose.yml, you can use `singularity-compose check`. Note that
this command requires jsonschema, so you should install via:
